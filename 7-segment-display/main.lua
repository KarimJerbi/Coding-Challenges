-- #117 Seven-Segment Display - Karim Jerbi (@apuleius) 06-2019
...
function love.draw()
	newDisplay(encoder(a),650,(window.height/2)-100,25)
	newDisplay(encoder(b),450,(window.height/2)-100,25)
	newDisplay(encoder(c),250,(window.height/2)-100,25)
	newDisplay(encoder(d),50,(window.height/2)-100,25)
